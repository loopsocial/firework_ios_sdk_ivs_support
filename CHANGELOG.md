...
- Remove initial buffer duration and integrate the new interface of the FireworkPlayer protocol

## [0.9.6]

### Changed

- Set initial buffer duration to 5 seconds

## [0.9.3]

### Changed

- Enhanced error handling with automatic retry count tracking and reset on successful playback
